      ...
      <div className="px-4 py-8 sm:px-8 sm:py-12 lg:px-16 xl:px-24">
        ...
        <footer className="rounded-xl border border-border bg-background py-10 text-center">
          ...
          <div className="flex items-center justify-center gap-8 flex-wrap">
            <a href="https://open.spotify.com" target="_blank" rel="noopener noreferrer" className="transition-all hover:scale-110 hover:drop-shadow-[0_0_12px_#1DB954]" style={{ color: '#1DB954' }}>
            ...
            <a href="https://music.apple.com" target="_blank" rel="noopener noreferrer" className="transition-all hover:scale-110 hover:drop-shadow-[0_0_12px_#FA243C]" style={{ color: '#FA243C' }}>
            ...
            <a href="https://www.tiktok.com" target="_blank" rel="noopener noreferrer" className="transition-all hover:scale-110 hover:drop-shadow-[0_0_12px_#E1E1E1] text-foreground">
            ...
            <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" className="transition-all hover:scale-110 hover:drop-shadow-[0_0_12px_#E4405F]" style={{ color: '#E4405F' }}>
            ...
            <a href="https://www.youtube.com/c/DJsSkillsQ35" target="_blank" rel="noopener noreferrer" className="transition-all hover:scale-110 hover:drop-shadow-[0_0_12px_#FF0000]" style={{ color: '#FF0000' }}>
            ...
            <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer" className="transition-all hover:scale-110 hover:drop-shadow-[0_0_12px_#1877F2]" style={{ color: '#1877F2' }}>
            ...
            <a href="https://www.twitch.tv" target="_blank" rel="noopener noreferrer" className="transition-all hover:scale-110 hover:drop-shadow-[0_0_12px_#9146FF]" style={{ color: '#9146FF' }}>
            ...
            <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="transition-all hover:scale-110 hover:drop-shadow-[0_0_12px_#E1E1E1] text-foreground">
