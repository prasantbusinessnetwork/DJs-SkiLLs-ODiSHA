export default async function handler(req: any, res: any) {
  ...
  const apiBase = (process.env.VITE_API_BASE_URL || process.env.VITE_API_URL || process.env.API_BASE_URL || "https://djs-skills-odisha-production.up.railway.app").replace(/\/$/, "");
