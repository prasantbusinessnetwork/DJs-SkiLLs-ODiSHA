...
app.get('/', (_req, res) => res.send('DJs SkiLLs ODiSHA Backend (Ironclad v6.4) is Online ✅'));
...
app.get('/api/test-ytdlp', async (req, res) => {
  ...
  res.write(`yt-dlp Diagnostic Test (v6.4)\n`);
...
app.listen(PORT, '0.0.0.0', () => console.log(`[server] Ironclad v6.4 Listening on port ${PORT}`));
